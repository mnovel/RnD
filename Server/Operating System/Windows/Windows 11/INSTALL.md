# INSTALL.md — Windows 11 (Production)
...
- Disarankan **Windows 11 Pro**
- Gunakan **Local Account** (bypass Microsoft Account jika perlu)
- TPM & Secure Boot aktif (default)
...
- BitLocker **opsional** (hindari jika aplikasi sensitif performa)
...
- RDP **opsional**
- Batasi user dan IP jika diaktifkan
